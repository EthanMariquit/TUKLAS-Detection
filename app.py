...
medical_data = {
    "Diamond-shaped Plaques (Erysipelas)": {
        ...
        "cause": """Caused by Erysipelothrix rhusiopathiae. Bacteria persists in soil for years. Infection often follows sudden diet changes.""",
    ...
    "Greasy / Exudative Skin (Greasy Pig Disease)": {
        ...
        "cause": """Caused by Staphylococcus hyicus. Bacteria enters through skin abrasions caused by fighting.""",
